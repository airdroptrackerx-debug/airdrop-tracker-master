...
import { BookOpen, Rocket, Trophy, Bell, Users, Sparkles, Shield } from 'lucide-react';
    ...
    <Drawer>
      ...
      <DrawerContent className="h-[90vh] sm:h-[85vh] flex flex-col">
        <div className="container mx-auto max-w-3xl flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 lg:px-6 overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
            <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20">
              ...
              <p className="text-muted-foreground">
                Your all-in-one crypto airdrop companion! Track tasks, discover new opportunities, earn achievements, and join an active community of airdrop hunters.
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="w-full pb-4">
              ...
              <AccordionItem value="explorer">
                ...
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Browse Airdrops:</strong> Find new projects across DeFi, Gaming, NFT, and Infrastructure categories
                    </li>
                    <li>
                      <strong>Filter & Search:</strong> Use search bar and filters to find airdrops matching your interests
                    </li>
                    <li>
                      <strong>Featured Projects:</strong> Look for ⭐ Featured badges for high-quality opportunities
                    </li>
                    <li>
                      <strong>New Alerts:</strong> Get notified when new airdrops are added (✨ NEW badge)
                    </li>
                    <li>
                      <strong>Quick Actions:</strong> Click "Join Airdrop" to participate or ℹ️ to learn more
                    </li>
                  </ul>
              ...
              <AccordionItem value="gamification">
                ...
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Daily Streaks:</strong> Complete tasks daily to build streaks and unlock future bonuses
                    </li>
                    <li>
                      <strong>Experience Levels:</strong> Earn XP from task completion and level up (Beginner → Master)
                    </li>
                    <li>
                      <strong>Achievement Badges:</strong> Unlock special badges for milestones (First Task, Week Warrior, etc.)
                    </li>
                    <li>
                      <strong>Progress Tracking:</strong> View your stats on the Profile page
                    </li>
                    <li>
                      <strong>Leaderboard coming soon:</strong> Your stats prepare you for future community competitions
                    </li>
                  </ul>
                  <p className="mt-2 text-sm text-muted-foreground">
              ...
              <AccordionItem value="notifications">
                ...
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Task Alerts:</strong> Get notified when tasks are completed or due soon
                    </li>
                    <li>
                      <strong>Achievement Unlocks:</strong> Celebrate when you earn new badges or reach milestones
                    </li>
                    <li>
                      <strong>New Airdrops:</strong> Alerts when fresh opportunities are added to Explorer
                    </li>
                    <li>
                      <strong>Streak Reminders:</strong> Don't break your streak - get reminded to complete daily tasks
                    </li>
                    <li>
                      <strong>Notification Center:</strong> Click the bell icon in navigation to view all notifications
                    </li>
                  </ul>
                  <p className="mt-2 text-sm text-muted-foreground">
              ...
              <AccordionItem value="community">
                ...
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Live User Count:</strong> Green indicator shows how many hunters are active (last 5 minutes)
                    </li>
                    <li>
                      <strong>Navbar Display:</strong> Desktop users see count in top navigation. Hover and click the X to hide it if distracting. Click the eye icon to show it again.
                    </li>
                    <li>
                      <strong>Footer Display:</strong> Mobile users see count at the bottom (always visible)
                    </li>
                    <li>
                      <strong>Profile Stats:</strong> View detailed community activity on your Profile page
                    </li>
                    <li>
                      <strong>Auto-Updates:</strong> Count refreshes every 30 seconds automatically
                    </li>
                  </ul>
                  <p className="mt-2 text-sm text-muted-foreground">
              ...
              <AccordionItem value="security">
                ...
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Email Verification:</strong> Verify your email after signup for added security
                    </li>
                    <li>
                      <strong>Social Login:</strong> Sign in with Google, Apple, or Twitter for convenience
                    </li>
                    <li>
                      <strong>Account Linking:</strong> Link multiple auth methods to one account
                    </li>
                    <li>
                      <strong>Password Change:</strong> Update your password anytime from Profile → Security Settings
                    </li>
                    <li>
                      <strong>Remember Me:</strong> Stay logged in across browser sessions
                    </li>
                    <li>
                      <strong>Account Deletion:</strong> Permanently delete your account and data if needed
                    </li>
                  </ul>
              ...
              <AccordionItem value="best-practices">
                <AccordionTrigger className="text-lg font-medium">Pro Tips & Best Practices</AccordionTrigger>
                <AccordionContent className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-2 mb-4">
                    ...
                    <li>
                      <strong>Use descriptive titles</strong> that clearly identify the project
                    </li>
                    <li>
                  ...
                  <ul className="list-disc pl-5 space-y-2 mb-4">
                    <li>
                      <strong>Check daily</strong> to maintain streaks and completion rates
                    </li>
                    <li>
                      <strong>Explore new airdrops</strong> weekly to find opportunities
                    </li>
                    <li>
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                      <strong>Complete all tasks</strong> for 100% daily completion
                    </li>
                    <li>
                      <strong>Unlock achievements</strong> for extra rewards
                    </li>
                    <li>
                      <strong>Stay active</strong> to contribute to community stats
                    </li>
                  </ul>
                </AccordionContent>
              </AccordionItem>
          ...
          <DrawerFooter className="flex-shrink-0 border-t bg-background pt-4 pb-8 px-4 lg:px-6">
            <DrawerClose asChild>
              <Button variant="outline" className="w-full">Close Guidelines</Button>
            </DrawerClose>
          </DrawerFooter>
        </div>
      </DrawerContent>
