...
export default function Donate() {
  ...
  const [qrErrors, setQrErrors] = useState<Set<string>>(new Set());

  // Prefill donor name when dialog opens
  useEffect(() => {
    if (showConfirmDialog && userProfile) {
      setDonorName(
        userProfile.nickname || userProfile.email?.split("@")[0] || ""
      );
    }
  ...
  const cryptoNetworks: CryptoNetwork[] = [
    {
      ...
      symbol: "SUI",
      address:
        "0x2db1e540059d3b7b7e3fa053fbd18942a24a3c337c71b3361d790d38c78214d4",
      network: "SUI Network",
    ...
    },
    {
      ...
      symbol: "NEAR",
      address:
        "075e3a9b9e32fd0a65bc8ead28617d3eb7788ce7fa8ce21a8fe0ea70be0735c4",
      network: "NEAR Protocol",
      qrCodePath: "/qr-codes/near-qr.png",
      majorTokens: ["NEAR", "SWEAT", "USDT", "ASI", "LINEAR", "REF"],
      icon: "near",
    ...
    },
    {
      name: "XRP",
      symbol: "XRP",
      address: "r4r598YmxXhnwJbSLcBAZPqk28iwhNPH81",
      network: "Ripple",
      qrCodePath: "/qr-codes/xrp-qr.png",
      majorTokens: ["XRP", "ARMY"],
      icon: "xrp",
    ...
    },
    {
      ...
      symbol: "ADA",
      address:
        "addr1q9tcyrz3s60v80gqgtp32wafyvn4n8s0p0ytpan4drm97euq59s9e9dfaq6zc4vwez9lgsavsa9ltcr5mm46tjdgcmssmuguhk",
    ...
    },
    {
      name: "Bitcoin",
      symbol: "BTC",
      address: "bc1qt5hn3yugu473ehv68qas69q3tkar8stw4y6vpx",
      network: "Bitcoin Network",
      qrCodePath: "/qr-codes/btc-qr.png",
      majorTokens: ["BTC", "ORDI", "SATS", "BTCS", "RATS", "LIGO", "piin"],
      icon: "btc",
  ...
  const handleConfirmDonation = async () => {
    ...
    try {
      ...
      toast.success("Thank you! 💙", {
        description:
          "Your confirmation has been recorded. We appreciate your support!",
      });
  ...
  const handleQrError = (qrId: string) => {
    setQrErrors((prev) => new Set(prev).add(qrId));
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-3">
            Help keep this platform free and ad-free for everyone. Your crypto
            donations directly support server costs, development, and new
            features.
          </p>
        ...
        <div className="bg-yellow-500/10 border-2 border-yellow-500/30 rounded-xl p-4 mb-8 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              ...
              Transactions on the blockchain are irreversible. Make sure you
              select the correct network matching the address provided.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card border-2 border-yellow-500/30 rounded-xl p-6 mb-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Instant, secure & supports all major cryptocurrencies
              </p>
            </div>
          </div>

          <p className="text-muted-foreground mb-4">
            Quickly donate via Binance Pay by scanning the QR code or entering
            the Pay ID.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={() =>
                    copyToClipboard(binancePayId, "Binance Pay ID")
                  }
            ...
            <div className="bg-muted/50 rounded-lg p-4 flex flex-col items-center justify-center">
              ...
              <div className="bg-white p-2 rounded-lg border-2 border-border w-48 h-48 flex items-center justify-center">
                {!qrErrors.has("binance-pay") ? (
                  <img
                    src="/qr-codes/binance-pay-qr.png"
                    alt="Binance Pay QR Code"
                    className="w-full h-full object-contain"
                    onError={() => {
                      setQrErrors((prev) => new Set(prev).add("binance-pay"));
                    }}
                  />
                ) : (
                  <div className="w-full h-full flex items-center justify-center bg-gray-100 rounded text-xs text-gray-500 text-center px-2">
                    QR Code
                    <br />
                    Missing
                  </div>
          ...
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              <strong>Instructions:</strong> Scan with Binance App or enter Pay
              ID to send your donation instantly and securely. Supports BTC,
              ETH, USDT, BNB, and 100+ other cryptocurrencies.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card border-2 border-blue-500/30 rounded-xl p-6 mb-8 shadow-lg">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold">
                Donate with EVM-Compatible Wallet
              </h2>
              <p className="text-sm text-muted-foreground">
                Supports Ethereum & all major EVM chains
              </p>
            </div>
          </div>

          <p className="text-muted-foreground mb-4">
            One address for all EVM-compatible networks: Ethereum, BNB Chain,
            Polygon, Avalanche, Arbitrum, Optimism, and more.
          </p>
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={() =>
                    copyToClipboard(evmWalletAddress, "EVM Address")
                  }
                  className="flex-shrink-0"
                >
              ...
              <div className="bg-white p-2 rounded-lg border-2 border-border w-48 h-48 flex items-center justify-center">
                {!qrErrors.has("evm") ? (
                  <img
                    ...
                    className="w-full h-full object-contain"
                    onError={() => {
                      setQrErrors((prev) => new Set(prev).add("evm"));
                    }}
                  />
                ) : (
                  <div className="w-full h-full flex items-center justify-center bg-gray-100 rounded text-xs text-gray-500 text-center px-2">
          ...
          <div className="mt-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
            <p className="text-sm text-green-900 dark:text-green-100">
              <strong>Supported Networks:</strong> Send ETH, USDT
              (ERC-20/BEP-20), USDC, BNB, MATIC, AVAX, LINK and other EVM
              tokens.
              <span className="font-semibold">
                {" "}
                Please verify the network before sending
              </span>{" "}
              - this wallet does NOT support TRC-20 (Tron).
            </p>
          </div>
        </div>
        ...
        <div className="bg-card border rounded-xl p-6 shadow-lg">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Network-specific addresses for dedicated donations
              </p>
            </div>
          </div>
          <p className="text-muted-foreground mb-6">
            Select your preferred network below. Each dropdown shows all major
                ...
                >
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    <div className="h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0 relative bg-gradient-to-br from-transparent to-transparent backdrop-blur-sm border-2 border-border/50 shadow-lg hover:shadow-xl transition-shadow">
                      <div
                        className={`absolute inset-0 rounded-full bg-gradient-to-br ${network.color} opacity-10 dark:opacity-20`}
                      ></div>
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (
                            ...
                            fallback.className =
                              "fallback-text font-bold text-sm";
                ...
                {expandedCrypto === network.symbol && (
                  <div className="px-4 pb-4 border-t bg-muted/20">
                    <div className="pt-4 space-y-4">
                      {/* Cardano-specific Warning */}
                      {network.symbol === "ADA" && (
                        <div className="bg-blue-500/10 border-2 border-blue-500/30 rounded-lg p-3 flex items-start gap-2">
                          <AlertTriangle className="h-5 w-5 text-blue-600 dark:text-blue-500 flex-shrink-0 mt-0.5" />
                          <div className="flex-1">
                            <p className="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-1">
                              ⚠️ ADA Only - Read Carefully!
                            </p>
                            <p className="text-xs text-blue-800 dark:text-blue-200">
                              Only use this address to deposit ADA on the
                              cardano. Please don't deposit inscriptions, NFTs,
                              or any other non-BTC assets, as they can't be
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          Scan with your wallet app or copy the address to
                          donate any of these tokens.
                        </p>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="flex justify-center">
                          <div className="bg-white p-2 rounded-lg border-2 border-border w-48 h-48 flex items-center justify-center">
                            {!qrErrors.has(network.symbol) ? (
                              <img
                                src={
                                  network.qrCodePath ||
                                  `/qr-codes/${network.symbol.toLowerCase()}-qr.png`
                                }
                                alt={`${network.name} QR Code`}
                                className="w-full h-full object-contain"
                                onError={() => {
                                  setQrErrors((prev) =>
                                    new Set(prev).add(network.symbol)
                                  );
                                }}
                              />
                            ) : (
                        ...
                        <div className="bg-background rounded-lg p-4 space-y-4">
                          <div>
                            ...
                            <Button
                              ...
                              className="w-full"
                              onClick={() =>
                                copyToClipboard(network.address, network.name)
                              }
                            >
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-muted-foreground">
            🙏 Thank you for your generous support! Your donation helps us keep
            improving Airdrop Tracker.
          </p>
        </div>
      </div>
      ...
      <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Your support means the world to us. Optionally leave your name or
              a message below.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="bg-muted/50 rounded-lg p-3 text-xs text-muted-foreground">
              💡 This is completely optional and only for our records. We'll use
              it to improve the platform and thank our supporters.
            </div>
          </div>
