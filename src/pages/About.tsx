...
export default function About() {
  ...
  useEffect(() => {
    if (userProfile && userProfile.hasCompletedOnboarding === false) {
      // User is visiting About page for the first time after signing up
  ...
  const features = [
    {
      ...
      description:
        "Organize and track all your crypto airdrop tasks in one place",
    ...
    },
    {
      ...
      title: "Level System",
      description:
        "Progress from Novice Explorer to Crypto Titan as you complete tasks",
        ...
        <div className="container relative mx-auto px-4" ref={heroRef}>
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Track, manage, and never miss another airdrop opportunity. Built
              by crypto enthusiasts, for crypto enthusiasts.
            </p>
        ...
        <div className="container mx-auto px-4 space-y-24">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                In the fast-paced world of crypto airdrops, opportunities come
                and go in the blink of an eye. Missing a task, forgetting a
                deadline, or losing track of requirements meant leaving money on
                the table.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We experienced this frustration firsthand. Sticky notes
                everywhere, spreadsheets that quickly became outdated, and the
                constant anxiety of "Did I complete that task?"
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Forgetting tasks meant lost airdrops
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      No tracking of progress or achievements
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      All your airdrop tasks in one place
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Streaks and levels keep you motivated
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Intuitive design that's a joy to use
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 md:order-2">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We built Airdrop Tracker to be the tool we wished existed. A
                beautiful, intuitive platform that makes tracking airdrops not
                just easy, but actually enjoyable.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                With gamification features like daily streaks and leveling
                systems, we turned airdrop hunting from a chore into an engaging
                experience that rewards consistency and dedication.
              </p>
            </div>
          </div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Today, thousands of crypto enthusiasts use Airdrop Tracker daily
                to stay on top of their opportunities. Our users have completed
                hundreds of thousands of tasks and maintained impressive
                streaks.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                But we're just getting started. We're constantly innovating,
                adding new features, and listening to our community to make
                Airdrop Tracker the best it can be.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4" ref={statsRef}>
              <Card className="p-6 text-center bg-gradient-to-br from-primary/10 to-accent/10">
                <div
                  className="stat-number text-4xl font-bold text-primary mb-2"
                  data-target="10000"
                >
                  0
                </div>
              ...
              <Card className="p-6 text-center bg-gradient-to-br from-green-500/10 to-emerald-500/10">
                <div
                  className="stat-number text-4xl font-bold text-green-600 dark:text-green-400 mb-2"
                  data-target="50000"
                >
                  0
                </div>
              ...
              <Card className="p-6 text-center bg-gradient-to-br from-orange-500/10 to-red-500/10">
                <div
                  className="stat-number text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2"
                  data-target="100"
                >
                  0
                </div>
              ...
              <Card className="p-6 text-center bg-gradient-to-br from-purple-500/10 to-pink-500/10">
                <div
                  className="stat-number text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2"
                  data-target="99"
                >
                  0
                </div>
          ...
          >
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <p className="text-lg text-white/90 max-w-2xl mx-auto">
                Join thousands of users who are already maximizing their airdrop
                opportunities with Airdrop Tracker.
              </p>
